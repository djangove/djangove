...
from djangove.blog.models import BlogPage
from djangove.contact.models import ContactPage
from djangove.events.models import EventPage
from djangove.pages.models import Advert, Testimonial
